[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/guilherme-argentino/video-maker-enhanced) 

# video-maker-enhanced
Passo-a-passo de criação da playlist https://www.youtube.com/playlist?list=PLMdYygf53DP4YTVeu0JxVnWq01uXrLwHi
...
vá até a pasta do projeto onde você clonou o repositório, navegue até a pasta **video-maker-enhanced\credentials**, crie um arquivo de texto e renomeie para `algorithmia.json`, dentro desse arquivo você irá colocar a `API` que copiou do site **Algorithmia** na estrutura abaixo:
``` js
{
  "apiKey": "API_KEY_AQUI"
}
...
Novamente, voltando na pasta do projeto ainda dentro da pasta **video-maker-enhanced\credentials** você ira criar um novo arquivo de texto com o nome `watson-nlu.json` e dentro desse arquivo você vai colar as credenciais que copiou anteriormente:
``` js
{
  "apikey" : "...",
...
Após isso irá aparecer sua Api Key, você vai copia-la e clicar no botão concluir, voltando a pasta do projeto você vai navegar até **video-maker-enhanced/credentials** e irá criar um novo arquivo chamado **google-search.json** com o conteúdo abaixo:
...
> Ps. No vídeo o Filipe orienta a criar um novo projeto para adicionar a api do Youtube, porem aqui, foi usando o mesmo projeto criado para o video-maker-enhanced, mas caso queria criar um novo projeto basta seguir os passos de **Criando o Projeto** que está no começo desse guia!
...
renomeio o arquivo para **google-youtube.json** e salve dentro da pasta **video-maker-enhanced/credentials** 😄

## 1.., 2..., 3... Testando! ##
Agora dentro da pasta **video-maker-enhanced** você pode abrir o **cmd** ou **powershell** e executar o comando:
```
npm start
```
