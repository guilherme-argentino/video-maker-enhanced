...
async function robot() {
  ...
  async function renderVideoWithNode() {
    return new Promise((resolve, reject) => {
      ...
      const destinationFilePath = fromRoot(`${rootPath}/content/output.mp4`);
      ...
      for (
        ...
        const slideTransition =
          content.sentences[sentenceIndex].wordcount.total *
          (60 / readingVelocity);
        images.push({
          ...
          filters: util.format(
            shuffledFilters[sentenceIndex],
            slideTransition * frameRate
          ),
        });
